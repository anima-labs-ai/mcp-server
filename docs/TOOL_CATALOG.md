...
| Metric | Value |
|---|---|
| Total registered tools | 196 |
| Tools with aliases | 3 |
| Total callable names (incl. aliases) | 202 |
...
**Source:** `src/tools/agent/agent/index.ts:50`
...
**Source:** `src/tools/agent/agent/index.ts:119`
...
**Source:** `src/tools/agent/agent/index.ts:66`
...
**Source:** `src/tools/agent/agent/index.ts:82`
...
**Source:** `src/tools/agent/agent/index.ts:135`
...
**Source:** `src/tools/agent/agent/index.ts:102`
...
| `manage_contacts` | List, create, or delete contacts used for email workflows. | — |
| `manage_folders` | List existing folders or create a new email folder. | — |
| `manage_templates` | List, create, or delete email templates. | — |
| `template_send` | Send an email by rendering and dispatching a stored template. | — |
...
**Source:** `src/tools/email/email/index.ts:635`
...
**Source:** `src/tools/email/email/index.ts:649`
...
**Source:** `src/tools/email/email/index.ts:677`
...
**Source:** `src/tools/email/email/index.ts:708`
...
**Source:** `src/tools/email/email/index.ts:493`
...
**Source:** `src/tools/email/email/index.ts:388`
...
**Source:** `src/tools/email/email/index.ts:404`
...
**Source:** `src/tools/email/email/index.ts:609`
...
**Source:** `src/tools/email/email/index.ts:622`
...
**Source:** `src/tools/email/email/index.ts:692`
...
**Source:** `src/tools/email/email/index.ts:425`
...
**Source:** `src/tools/email/email/index.ts:542`
...
**Source:** `src/tools/email/email/index.ts:362`
...
**Source:** `src/tools/email/email/index.ts:554`

### `manage_contacts`

List, create, or delete contacts used for email workflows.

**Input schema:** `manageContactsSchema` — see source for fields.

**Source:** `src/tools/email/email/index.ts:746`

### `manage_folders`

List existing folders or create a new email folder.

**Input schema:** `manageFoldersSchema` — see source for fields.

**Source:** `src/tools/email/email/index.ts:721`

### `manage_templates`

List, create, or delete email templates.

**Input schema:** `manageTemplatesSchema` — see source for fields.

**Source:** `src/tools/email/email/index.ts:780`

### `template_send`

Send an email by rendering and dispatching a stored template.

**Input schema:** `templateSendSchema` — see source for fields.

**Source:** `src/tools/email/email/index.ts:817`
...
**Source:** `src/tools/email/message/index.ts:229`
...
**Source:** `src/tools/email/message/index.ts:330`
...
**Source:** `src/tools/email/message/index.ts:212`
...
**Source:** `src/tools/email/message/index.ts:314`
...
**Source:** `src/tools/phone/phone/index.ts:184`
...
**Source:** `src/tools/phone/phone/index.ts:148`
...
**Source:** `src/tools/phone/phone/index.ts:165`
...
**Source:** `src/tools/phone/phone/index.ts:125`
...
**Source:** `src/tools/phone/phone/index.ts:198`
...
**Source:** `src/tools/phone/phone/index.ts:261`
...
**Source:** `src/tools/phone/phone/index.ts:235`
...
| `Check Health` | Check API health status from the server health endpoint. Use this before trouble… | — |
...
| `List Agents` | List available agents with optional pagination. Use this as a discovery utility … | — |
...
| `Who Am I` | Return identity details for the current API credential. Use this to verify which… | — |
...
**Source:** `src/tools/platform/utility/index.ts:218`
...
**Source:** `src/tools/platform/utility/index.ts:456`
...
**Source:** `src/tools/platform/utility/index.ts:281`
...
**Source:** `src/tools/platform/utility/index.ts:392`
...
**Input schema:** `listAgentsInput` — see source for fields.

**Source:** `src/tools/platform/utility/index.ts:298`
...
**Source:** `src/tools/platform/utility/index.ts:319`
...
**Source:** `src/tools/platform/utility/index.ts:583`
...
**Source:** `src/tools/platform/utility/index.ts:359`
...
**Source:** `src/tools/platform/utility/index.ts:561`
...
**Source:** `src/tools/platform/utility/index.ts:543`
...
**Source:** `src/tools/platform/utility/index.ts:513`
...
**Source:** `src/tools/platform/utility/index.ts:419`
...
**Source:** `src/tools/platform/utility/index.ts:264`
...
**Source:** `src/tools/vault/vault/index.ts:656`
...
**Source:** `src/tools/vault/vault/index.ts:290`
...
**Source:** `src/tools/vault/vault/index.ts:518`
...
**Source:** `src/tools/vault/vault/index.ts:317`
...
**Source:** `src/tools/vault/vault/index.ts:241`
...
**Source:** `src/tools/vault/vault/index.ts:331`
...
**Source:** `src/tools/vault/vault/index.ts:256`
...
**Source:** `src/tools/vault/vault/index.ts:459`
...
**Source:** `src/tools/vault/vault/index.ts:613`
...
**Source:** `src/tools/vault/vault/index.ts:634`
...
**Source:** `src/tools/vault/vault/index.ts:588`
...
**Source:** `src/tools/vault/vault/index.ts:481`
...
**Source:** `src/tools/vault/vault/index.ts:560`
...
**Source:** `src/tools/vault/vault/index.ts:369`
...
**Source:** `src/tools/vault/vault/index.ts:440`
...
**Source:** `src/tools/vault/vault/index.ts:405`
...
**Source:** `src/tools/vault/vault/index.ts:391`
...
**Source:** `src/tools/vault/vault/index.ts:302`
